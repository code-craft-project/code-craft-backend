...
export const EVENT_SELECT_PROPS: string = 'events.id as id, title, events.description as description, is_public, password, logo_url, start_at, end_at, organization_id, is_team_based, max_team_members';
