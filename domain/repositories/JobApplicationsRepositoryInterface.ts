export const JOB_APPLICATION_CREATE_PROPS: string = 'job_post_id, user_id';
export const JOB_APPLICATION_SELECT_PROPS: string = 'job_applications.id as id, job_post_id, job_applications.user_id as user_id, job_applications.created_at as created_at';
